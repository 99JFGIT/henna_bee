...
import 'package:henna_bee/authentication/registration_screen.dart';
...
import 'package:henna_bee/customer_home_page.dart';
import 'package:http/http.dart' as http;
import 'package:internet_connection_checker/internet_connection_checker.dart';

import '../admin/admin_homepage.dart';
import '../api/api_connection.dart';
import '../artist/artist_homepage.dart';
      ...
      try {
        ...
        if (res.statusCode == 200) {
          ...
          if (responseData['success'] == true) {
            ...
            } else if (userRole == 'Client') {  // Add condition for 'Client' role
              Get.offAll(() => CustomerHomePage()); // Assuming you have a ClientHomepage
            }
          } else {
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: GoogleFonts.acme(
            color: Colors.white,
            fontSize: 35.0, // Specify your desired font size here
          ),
        ),
        centerTitle: true,
